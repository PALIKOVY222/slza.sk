        ...
        <div className="flex items-center justify-between min-h-[600px] relative">
          <div className="flex-1 text-left z-[2]">
            ...
            <div className="flex gap-[30px] justify-start items-center">
              ...
              <a href="https://instagram.com/tlaciarenslza" target="_blank" rel="noopener noreferrer" className="bg-transparent text-white border-2 border-white py-[16px] px-8 text-base font-semibold rounded-[5px] inline-flex items-center gap-2 transition-all duration-300 hover:bg-white hover:text-[#0087E3]">
