        ...
        <div className="flex items-center justify-between min-h-[600px] relative">
          <div className="flex-1 text-left z-[2]">
            ...
            <SplitText
              ...
              tag="h1"
            />
            <p className="text-lg text-white/80 mb-8 max-w-[500px] leading-relaxed" style={{ animation: 'fadeInUp 0.7s ease forwards', animationDelay: '1.4s', opacity: 0 }}>
              Spustili sme nový online obchod! Objednávajte vizitky, letáky, bannery, plagáty a veľa ďalšieho priamo z pohodlia domova.
            </p>
            <div className="flex gap-4 justify-start items-center flex-wrap" style={{ animation: 'fadeInUp 0.7s ease forwards', animationDelay: '1.8s', opacity: 0 }}>
      ...
      <div className="lg:hidden px-5 text-center relative min-h-[500px] flex flex-col justify-center">
        ...
        <div className="relative z-[2] pt-28">
          ...
          <SplitText
            ...
            tag="h1"
          />
          <p className="text-sm text-white/80 mb-6 max-w-[320px] mx-auto leading-relaxed" style={{ animation: 'fadeInUp 0.7s ease forwards', animationDelay: '1.4s', opacity: 0 }}>
            Spustili sme nový online obchod! Objednávajte priamo z pohodlia domova.
          </p>

          {/* Buttons */}
          <div className="flex flex-col gap-3 justify-center items-center mb-6" style={{ animation: 'fadeInUp 0.7s ease forwards', animationDelay: '1.8s', opacity: 0 }}>
