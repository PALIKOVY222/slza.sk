...
const Hero = () => {
  return (
    <section className="bg-[#0087E3] text-white pt-32 md:pt-40 pb-2 mb-0 relative overflow-visible" id="home">
      ...
      {/* Mobile Features - same background as desktop */}
      <div className="lg:hidden bg-[rgba(45,95,93,0.85)] backdrop-blur-[10px] mx-4 rounded-[20px] relative z-[3] -mt-8 mb-6 py-6 px-5">
        <div className="flex flex-col gap-5">
          <div className="flex items-start gap-4 text-white">
            ...
            <div className="flex-1">
              <h4 className="text-sm font-bold mb-1 text-white">Zadarmo doprava</h4>
              <p className="text-xs text-white/80">Pri objednávke nad 50€ a zároveň do 50kg</p>
            </div>
          </div>
          <div className="flex items-start gap-4 text-white">
            <div className="flex-shrink-0 w-[40px] h-[40px] flex items-center justify-center">
            ...
            <div className="flex-1">
              <h4 className="text-sm font-bold mb-1 text-white">Grafické práce ZADARMO</h4>
              <p className="text-xs text-white/80">30 minút grafických prác. Možnosť dokúpenia, 29€/hodina.</p>
            </div>
          </div>
          <div className="flex items-start gap-4 text-white">
            <div className="flex-shrink-0 w-[40px] h-[40px] flex items-center justify-center">
            ...
            <div className="flex-1">
              <h4 className="text-sm font-bold mb-1 text-white">Podpora 24/7</h4>
              <p className="text-xs text-white/80">Kontaktujte nás kedykoľvek</p>
            </div>
          </div>
          <div className="flex items-start gap-4 text-white">
            <div className="flex-shrink-0 w-[40px] h-[40px] flex items-center justify-center">
            ...
            <div className="flex-1">
              <h4 className="text-sm font-bold mb-1 text-white">100% Garancia reklamácie</h4>
              <p className="text-xs text-white/80">V prípade nespokojnosti s kvalitou tlače do 150€</p>
            </div>
          </div>
        </div>
      </div>
